            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full px-24 text-white">
                ...
                <div class="text-center mb-14 max-w-lg">
                    <p class="text-xl text-white/95 leading-relaxed">
                        Kelola bisnis Anda dengan mudah dan efisien menggunakan sistem kasir modern untuk kebutuhan usaha Anda.
                    </p>
                </div>
        ...
        <div class="flex-1 lg:w-1/2 flex items-center justify-center px-8 sm:px-12 lg:px-20 xl:px-32 bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-gray-600 text-lg">Silakan login untuk melanjutkan ke dashboard</p>
                </div>
                    ...
                    <div class="flex items-center justify-between pt-2">
                        <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                            <input id="remember_me" 
                                type="checkbox" 
                                class="w-4 h-4 rounded border-gray-300 text-purple-600 focus:ring-purple-500 cursor-pointer transition" 
                                name="remember">
                            <span class="ml-2.5 text-sm text-gray-600 group-hover:text-gray-900 transition">Ingat saya</span>
                        </label>

                        @if (Route::has('password.request'))
                            <a class="text-sm font-semibold text-purple-600 hover:text-purple-700 transition" 
